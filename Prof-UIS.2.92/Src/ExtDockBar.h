...
class __PROF_UIS_API CExtDockBar
	: public CDockBar
	, CExtPmBridge
{
	...
	DECLARE_CExtPmBridge_MEMBERS( CExtPmBridge );
...
public:
	bool m_bHelperSizing:1, m_bHelperLockNearestLayout:1;
	virtual void _LockSequenceOptimization( bool bLock );
...
protected:
	...
	mutable INT m_nDelVisUpdateCounter;
public:
	virtual bool _IsDelayedVisibilityUpdateEnabled() const;
