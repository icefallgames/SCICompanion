...
public:
	...
	enum e_paint_manager_name_t
	{
		...
		OfficeXP				= 29751,
		Office2003				= 29752,
		Office2003NoThemes		= 29753,
		Studio2005				= 29754,
		Studio2008				= 29755,
		NativeXP				= 29756,
		Office2007_R1			= 29757,
		Office2007_R2_LunaBlue	= 29758,
		Office2007_R2_Obsidian	= 29759,
		Office2007_R2_Silver	= 29760,
		Office2007_R3_LunaBlue	= 29761,
		Office2007_R3_Obsidian	= 29762,
		Office2007_R3_Silver	= 29763,
		Office2010_R1			= 29764,
		Office2010_R2_Blue		= 29765,
		Office2010_R2_Silver	= 29766,
		Office2010_R2_Black		= 29767,
		Studio2010              = 29768,
		ProfSkinPainter			= 29769,
	};
...
class __PROF_UIS_API CExtPaintManagerStudio2010 : public CExtPaintManagerStudio2005
{
public:
	DECLARE_SERIAL( CExtPaintManagerStudio2010 );

	// construction/destruction
	CExtPaintManagerStudio2010();
	virtual ~CExtPaintManagerStudio2010();
	...
	COLORREF m_clrDockerBkgndTop, m_clrDockerBkgndMiddle, m_clrDockerBkgndBottom, m_clrDockerBkgndDot1, m_clrDockerBkgndDot2;
	CExtBitmap m_bmpDockerBkgndDots;
	COLORREF m_clrOuterDockBarBkgnd;
	
	COLORREF m_clrToolbarBkgnd, m_clrToolbarBorder;
	CExtBitmap m_bmpToolBarBkgnd;
	...
	COLORREF m_clrMenuBarGriadient1, m_clrMenuBarGriadient2;
	virtual void PaintFloatToolbarRowBk(
		CDC & dc,
		const CExtToolControlBar * pBar,
		int nLastReviewBtnIdx,
	...
	COLORREF m_clrTbExpHoverLight1, m_clrTbExpHoverLight2, m_clrTbExpHoverDark1, m_clrTbExpHoverDark2,
		m_clrTbExpPressedLight1, m_clrTbExpPressedLight2, m_clrTbExpPressedDark1, m_clrTbExpPressedDark2,
		m_clrTbExpGlyphNormal, m_clrTbExpGlyphHover, m_clrTbExpGlyphPressed;
	CExtBitmap m_bmpTbExpNormalH, m_bmpTbExpHoverH, m_bmpTbExpPressedH;
	CExtBitmap m_bmpTbExpNormalV, m_bmpTbExpHoverV, m_bmpTbExpPressedV;
	virtual void PaintToolbarExpandButton(
		CDC & dc,
		const RECT & rcButtonArea,
		bool bHorz, // if false - down
	...
	COLORREF m_arrClrBarCaptionActive[5], m_arrClrBarCaptionInactive[5];
	CExtBitmap m_bmpBarCaptionActive, m_bmpBarCaptionInactive;
	COLORREF m_clrDockingFrameBorder, m_clrCaptBtnBorder, m_clrCaptBtnGlyphBkgndHover, m_clrCaptBtnGlyphBkgndPressed,
		m_clrCaptBtnGlyphDisabled, m_clrCaptBtnGlyphInactiveNormal, m_clrCaptBtnGlyphActiveNormal, m_clrCaptBtnGlyphHover, m_clrCaptBtnGlyphPressed,
		m_clrCaptBtnTextNormal, m_clrCaptBtnTextActive;
	...
	COLORREF m_arrClrMenuItemSelectionAreaGradient[5]; // top,middle1,middle2,bottom,border
	CExtBitmap m_bmpMenuItemSelectionArea;
	virtual bool PaintMenuItemSelectionAreaXP(
		CDC & dc,
		CExtPaintManager::PAINTMENUITEMDATA & _pmid,
		const RECT & rcSelectionArea
...
#if (!defined __EXT_MFC_NO_TAB_CTRL)
	struct __PROF_UIS_API vs_2010_tab_item_def_t
	{
		// all the colors can be COLORREF(-1L) - transparent
		COLORREF m_clrGradient[4]; // 0 - top, 1 - middle, 2 - middle, 3 - bottom
		COLORREF m_clrText, m_clrBorder; // text, border
		CExtBitmap m_bmpTabItem, m_bmpNearItemsArea;
		CRect m_rcBmpPadding;
		vs_2010_tab_item_def_t();
		void GenerateBmp();
		void CreateRotatedVersionFromTopOrientedVersion(
			const vs_2010_tab_item_def_t & _srcDef,
			INT nTargetVersionType // CExtPaintManagerOffice2007_Impl::__ETSOI_***
			);
	};
	enum e_vs_2010_tab_item_type_t
	{
		__ETI2010_DISABLED = 0, // empty
		__ETI2010_NORMAL = 1, // empty
		__ETI2010_NORMAL_GROUPPED = 2, // dark + no border
		__ETI2010_HOVER = 3, // semi transparent gradient
		__ETI2010_SELECTED = 4, // gray gradient
		__ETI2010_SELECTED_ACTIVE = 5, // yellow gradient
		__ETI2010_SELECTED_CB = 6, // white
		__ETI2010_COUNT = 7,
	};
	vs_2010_tab_item_def_t m_tabDefs[ __ETI2010_COUNT ][4]; // the [4] slice is CExtPaintManagerOffice2007_Impl::__ETSOI_***
#endif // (!defined __EXT_MFC_NO_TAB_CTRL)
...
*/
	...
	SCROLLBARSKINDATA m_SbSkinDataH, m_SbSkinDataV;
	virtual SCROLLBARSKINDATA * ScrollBar_GetSkinData(
		bool bHorzBar,
		CObject * pHelperSrc,
		LPARAM lParam = 0L,
...
}; // class CExtPaintManagerStudio2010
