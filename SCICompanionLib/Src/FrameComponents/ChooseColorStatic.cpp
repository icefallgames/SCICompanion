...
void CChooseBrushStatic::_DrawItem(CDC *pDC, int cx, int cy)
{
    ...
    BYTE indexBrush[PATTERN_BMP_SIZE];
    // Fake a PicData to draw into, with a visual brush.
    PicData data = { PicScreenFlags::Visual, (uint8_t*)&dataBrush, nullptr, nullptr, nullptr, (uint8_t*)&indexBrush, false, false, size16(DEFAULT_PIC_WIDTH, DEFAULT_PIC_HEIGHT), false, false, nullptr };
