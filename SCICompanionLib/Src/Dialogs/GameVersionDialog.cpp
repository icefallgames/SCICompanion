...
void CGameVersionDialog::_Sync()
{
    ...
    _fPicPolygons = _version.UsesPolygons ? 1 : 0;
...
SCIVersion CGameVersionDialog::_ReverseSync()
{
    ...
    version.UsesPolygons = (_fPicPolygons != 0);
...
void CGameVersionDialog::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_CHECKPOLYGONS, m_wndPicPolygons);
    ...
    DDX_Check(pDX, IDC_CHECKPOLYGONS, _fPicPolygons);
