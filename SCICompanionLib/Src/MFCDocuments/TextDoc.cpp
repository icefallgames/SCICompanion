...
bool CTextDoc::v_DoPreResourceSave()
{
    if (GetResource())
    {
        const TextComponent &text = GetResource()->GetComponent<TextComponent>();
        if (text.WasAutoGenerated() &&
            (IDYES != AfxMessageBox("This text resource was auto-generated by SCI Companion during a script compile.\nDo you still wish to save over it?", MB_YESNO | MB_ICONEXCLAMATION)))
        {
            return false;
        }
    }
