...
void ConvertCelToNewPalette(int *trackUsage, Cel &cel, PaletteComponent &currentPalette, uint8_t transparentColor, bool isEGA16, bool g_fDitherImages2, int colorCount, const uint8_t *paletteMapping, const RGBQUAD *colors);